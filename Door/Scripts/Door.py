...
class Door:
    ...
    def __init__(self, geneList):
        ...
        self.firstSectionType = Gene(geneList[19], 3, 0, 2, False)
...
class DoorGeneGenerator:
    def __init__(self):
        ...
        self.firstSectionType = random.randint(0,2)
